...
- Use built-in WebSearch for lookups. Deep Research for broad questions.

IMPORTANT — NOTIFICATIONS:
- Use built-in PushNotification. One line, ≤200 chars.
...
STEP 7 — Notification: only if action was taken. Call PushNotification with
a one-line action summary.
