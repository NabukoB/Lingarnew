...
- `daytrade_count` leaves room (< 3 on a sub-$25k account)
- Specific catalyst documented in today's RESEARCH-LOG entry
- Instrument is a stock (not an option, not anything else)

## Sell-Side Rules
- If unrealized P&L ≤ -7%: close immediately
- If thesis broke (catalyst invalidated, sector rolling, news): close
- If up ≥ +20%: tighten trailing stop to 5%
- If up ≥ +15%: tighten trailing stop to 7%
